  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Contas à pagar</h1>
        <a title="Cadastrar conta" href="/contas-pagar/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            <React.Fragment key={i}>
                              <tr>
                                ...
                                <td className="text-center no-sort">
                                  <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/contas-pagar/1"><i className="fas fa-user-edit"></i></a>
                              ...
                              <tr>
                                ...
                                <td>25/05/2020</td>
                                <td>Aguardando pagamento</td>
                                <td><span className="badge badge-secondary btn-sm">À pagar</span></td>
                                <td className="text-center no-sort">
                                  <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/contas-pagar/1"><i className="fas fa-user-edit"></i></a>
                                  <a title="Excluir" className="btn btn-sm btn-danger" href="javascript(void)" data-toggle="modal" data-target="#produto"><i className="fas fa-user-times"></i></a>
                                </td>
