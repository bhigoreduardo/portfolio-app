  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Formas de pagamento</h1>
        <a title="Cadastrar forma de pagamento" href="/formas-pagamento/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
      ...
      <div className="card shadow mb-4">
          <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Lista de formas de pagamento</h6>
          </div>
              ...
              <div className="table-responsive">
                  <table className="table table-bordered dataTable" id="dataTable" width="100%">
                      <thead>
                        <tr>
                          <th>Método</th>
                          <th className="text-center pr-2" width="10%">Parcela</th>
                          ...
                          Array.from({length: 5}).map((_, i) => (
                            ...
                            <tr>
                              ...
                              <td className="text-center no-sort">
                                <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/formas-pagamento/1"><i className="fas fa-user-edit"></i></a>
                            ...
                            <tr>
                              <td>Boleto</td>
                              <td className="text-center"><span className="badge badge-secondary btn-sm">Não</span></td>
