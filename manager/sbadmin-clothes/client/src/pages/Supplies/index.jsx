  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Fornecedores</h1>
        <a title="Cadastrar fornecedor" href="/fornecedores/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
      ...
      <div className="card shadow mb-4">
          <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Lista de fornecedores</h6>
          </div>
                      ...
                      <tbody>
                        {
                          Array.from({length: 20}).map((_, i) => (
                            ...
                            <tr>
                              <td>Jurandir Carrasco</td>
                              <td>123.456.789-23</td>
                              <td>PF</td>
                              <td>(11) 9 87456-1234</td>
                              <td>jurandir@carraso.com</td>
                              <td>{`Rua do Jurandir Carrasco, N° 789 Bairro Principal`.substring(0, 30)}</td>
                              <td className="text-center"><span className="badge badge-info">Sim</span></td>
                              <td className="text-center no-sort">
                                <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/fornecedores/1"><i className="fas fa-user-edit"></i></a>
