  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Vendas</h1>
        <a title="Cadastrar venda" href="/vendas/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
      ...
      <div className="card shadow mb-4">
          <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Lista de vendas</h6>
          </div>
                  ...
                  <table className="table table-bordered dataTable" id="dataTable" width="100%">
                      <thead>
                        <tr>
                          <th>Cliente</th>
                          <th>Vendedor</th>
                          <th className="text-center pr-2">Data cadastro</th>
                          <th className="text-center pr-2">Forma de pagamento</th>
                          <th className="text-center pr-2">Valor total</th>   
                      ...
                      <tbody>
                        {
                          Array.from({length: 5}).map((_, i) => (
                            ...
                            <tr>
                              <td>Jurandir Estrela</td>
                              <td>Jurandir Gomes</td>
                              <td className="text-center">25/05/2020</td>
                              <td className="text-center">Cartão de crédito</td>
                              <td className="text-center">R$250,00</td>
                              <td className="text-center"><span className="badge badge-info btn-sm">Pago</span></td>
                              <td className="text-center no-sort">
                                <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/vendas/1"><i className="fas fa-user-edit"></i></a>
                            ...
                            <tr>
                              ...
                              <td>Jurandir Gomes</td>
                              <td className="text-center">25/05/2020</td>
                              <td className="text-center">PIX</td>
                              <td className="text-center">R$250,00</td>
                              <td className="text-center"><span className="badge badge-warning btn-sm">Pendente</span></td>
