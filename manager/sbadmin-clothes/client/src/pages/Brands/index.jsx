  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a title="Cadastrar marca" href="/marcas/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                          ...
                          Array.from({length: 20}).map((_, i) => (
                            ...
                            <tr>
                              ...
                              <td className="text-center no-sort">
                                <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/marcas/1"><i className="fas fa-user-edit"></i></a>
