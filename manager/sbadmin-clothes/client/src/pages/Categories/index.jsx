  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a title="Cadastrar marca" href="/categorias/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
      ...
      <div className="card shadow mb-4">
          <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Lista de categorias</h6>
          </div>
                      ...
                      <tbody>
                        {
                          Array.from({length: 20}).map((_, i) => (
                            ...
                            <tr>
                              <td>Masculino</td>
                              <td>25 Agosto 2020</td>
                              <td className="text-center"><span className="badge badge-info">Sim</span></td>
                              <td className="text-center no-sort">
                                <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/categorias/1"><i className="fas fa-user-edit"></i></a>
