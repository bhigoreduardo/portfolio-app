  ...
  return (
    <Layout>
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Vendedores</h1>
        <a title="Cadastrar vendedor" href="/vendedores/cadastro" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
      ...
      <div className="card shadow mb-4">
          <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Lista de vendedores</h6>
          </div>
                          ...
                          Array.from({length: 20}).map((_, i) => (
                            ...
                            <tr>
                              ...
                              <td className="text-center no-sort">
                                <a title="Editar" className="btn btn-sm btn-primary mr-2" href="/vendedores/1"><i className="fas fa-user-edit"></i></a>
