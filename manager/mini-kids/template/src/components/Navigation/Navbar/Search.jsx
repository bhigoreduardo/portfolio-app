  ...
  return (
    <div className="flex items-center md:ml-auto md:pr-4">
      <div className="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease">
        ...
        <ul className={`${showSearch ? "opacity-100 left-0 right-0 z-50" : "opacity-0"} hidden max-h-100 overflow-y-auto top-full lg:mt-2 lg:block lg:absolute lg:right-0 lg:left-auto lg:shadow-3xl lg:min-w-90 min-w-60 w-full absolute list-none rounded-lg dark:shadow-dark-xl dark:bg-slate-850 bg-white bg-clip-padding px-2 py-4`}>
          {
            products?.length > 0 &&
              products.map((item, i) => (
