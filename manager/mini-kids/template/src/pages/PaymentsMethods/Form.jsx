            ...
            <div className="flex-auto p-6">
              ...
              <div className="flex flex-wrap py-3">
                <div className="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0 mb-3">
                  <TextField id="name" label="Nome" icon="fas fa-archive" title="Nome" name="email" placeholder="Informe o nome" />
                </div>
                <div className="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0 mb-3">
                  <TextField id="installments" label="Parcelas" icon="fas fa-credit-card" title="Parcelas" name="installments" placeholder="Informe as parcelas" />
                </div>
              </div>
