<?php
  ...
  try {
    $query = "";
    if (!empty($_FILES)) {
      $query = "UPDATE supplies SET personType=:personType, email=:email, name=:name, lastName=:lastName, phone=:phone, mobile=:mobile, cpfCnpj=:cpfCnpj, rgIe=:rgIe, birthday=:birthday, image=:image, address=:address, city=:city, state=:state, neighborhood=:neighborhood, zipCode=:zipCode, number=:number, complement=:complement, status=:status, obs=:obs WHERE id=:id";
    } else {
      $query = "UPDATE supplies SET personType=:personType, email=:email, name=:name, lastName=:lastName, phone=:phone, mobile=:mobile, cpfCnpj=:cpfCnpj, rgIe=:rgIe, birthday=:birthday, address=:address, city=:city, state=:state, neighborhood=:neighborhood, zipCode=:zipCode, number=:number, complement=:complement, status=:status, obs=:obs WHERE id=:id";
    }
