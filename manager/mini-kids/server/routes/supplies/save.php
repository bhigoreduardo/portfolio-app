<?php
  ...
  try {
    $query = "";
    if (!empty($_FILES)) {
      $query = "INSERT INTO supplies (personType, email, name, lastName, phone, mobile, cpfCnpj, rgIe, birthday, image, address, city, state, neighborhood, zipCode, number, complement, status, obs) VALUES (:personType, :email, :name, :lastName, :phone, :mobile, :cpfCnpj, :rgIe, :birthday, :image, :address, :city, :state, :neighborhood, :zipCode, :number, :complement, :status, :obs)";
    } else {
      $query = "INSERT INTO supplies (personType, email, name, lastName, phone, mobile, cpfCnpj, rgIe, birthday, address, city, state, neighborhood, zipCode, number, complement, status, obs) VALUES (:personType, :email, :name, :lastName, :phone, :mobile, :cpfCnpj, :rgIe, :birthday, :address, :city, :state, :neighborhood, :zipCode, :number, :complement, :status, :obs)";
    }
