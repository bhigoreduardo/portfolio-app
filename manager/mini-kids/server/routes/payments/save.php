<?php
  ...
  try {
    $query = "";
    if ($_POST['status'] == 1) {
      $query = "INSERT INTO payments (supply, deadlineAt, paymentAt, amount, paymentMethod, status, obs) VALUES (:supply, :deadlineAt, :paymentAt, :amount, :paymentMethod, :status, :obs)";
    } else {
      $query = "INSERT INTO payments (supply, deadlineAt, amount, paymentMethod, status, obs) VALUES (:supply, :deadlineAt, :amount, :paymentMethod, :status, :obs)";
    }
